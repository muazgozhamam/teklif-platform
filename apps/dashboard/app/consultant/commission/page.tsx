...
export default function ConsultantCommissionPage() {
  ...
  React.useEffect(() => {
    (async () => {
      ...
      setError(null);
      try {
        const res = await api.get<Payload>('/consultant/commission/my');
        setData(res.data);
      } catch (e: any) {
  ...
  return (
    <RoleShell role="CONSULTANT" title="Hakedişim" subtitle="Kazanılan, ödenen ve kalan tutarları buradan takip edersiniz." nav={[]}>
