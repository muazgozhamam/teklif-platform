        ...
        {nav.map((item) => {
          ...
          return (
            <Link
              ...
              onClick={onNavigate}
              className={cn(
                'ui-interactive group relative block rounded-xl border px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus-ring)]',
                active
